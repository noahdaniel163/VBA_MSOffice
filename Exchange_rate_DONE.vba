Sub SendEmails()
    ...
    For Each cell In rngCompanies
        ...
        ' Attach files containing "Exchange" or "TyGia" in the name for this company
        Set objFolder = objFSO.GetFolder(strFolderPath)
        For Each objFile In objFolder.Files
            strFileName = objFile.Name
            If InStr(strFileName, "Exchange") > 0 Or InStr(strFileName, "TyGia") > 0 Then
        ...
        If bAttachmentsAdded Then
            ...
            With olMail
                ...
                .HTMLBody = "<font size='2' face='Arial'>" & _
                                ...
                                "We are writing to you the PDF file(s) of the exchange rate of the month. Please find attached the file(s) with the details.<br><br>" & _
