' Done Send multiple files to the same email, if there is no file with the correct company name, skip it and continue sending
Sub SendEmails()
    ...
    For Each cell In rngCompanies
        ...
        For Each objFile In objFolder.Files
            ...
            If InStr(strFileName, strCompany) > 0 Then
        ...
        If bAttachmentsAdded Then
            ...
            With olMail
                .Subject = "Statement " & CurrentMonth & " from Busan Bank Ho Chi Minh City Branch"
                .To = strEmail
                '.Body = "Dear Customer, please find attached your monthly statement."
                .HTMLBody = "<font size='2' face='Arial'>" & _
                                "Dear Customer,<br><br>" & _
                                "We are writing to you regarding your account statement for the end of the month. Please find attached a PDF file with the details of your transactions and balance.<br><br>" & _
                                "We hope you are satisfied with our products and services.<br><br>" & _
